...
namespace iOrder.Controllers
{
    public partial class SubjectsController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SubjectsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubjectsController Actions { get { return MVC.Subjects; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Subjects";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Subjects";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string filterHeaderTemplate = "filterHeaderTemplate";
        ...
        public class ActionNameConstants
        {
            ...
            public const string filterHeaderTemplate = "filterHeaderTemplate";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string GetSubjects = "GetSubjects";
                public readonly string Index = "Index";
            }
            public readonly string Create = "~/Views/Subjects/Create.cshtml";
            public readonly string Delete = "~/Views/Subjects/Delete.cshtml";
            public readonly string Details = "~/Views/Subjects/Details.cshtml";
            public readonly string Edit = "~/Views/Subjects/Edit.cshtml";
            public readonly string filterHeaderTemplate = "~/Views/Subjects/filterHeaderTemplate.cshtml";
            public readonly string GetDocuments = "~/Views/Subjects/GetDocuments.cshtml";
            public readonly string GetSubjects = "~/Views/Subjects/GetSubjects.cshtml";
            public readonly string Index = "~/Views/Subjects/Index.cshtml";
        }
    }
    ...
    public partial class T4MVC_SubjectsController : iOrder.Controllers.SubjectsController
    {
        ...
        [NonAction]
        partial void filterHeaderTemplateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult filterHeaderTemplate()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.filterHeaderTemplate);
            filterHeaderTemplateOverride(callInfo);
            return callInfo;
        }
        ...
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(iOrder.Entity.Subject subject)
        {
            ...
            CreateOverride(callInfo, subject);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
        ...
        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> DeleteConfirmed(long id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.DeleteConfirmed);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
