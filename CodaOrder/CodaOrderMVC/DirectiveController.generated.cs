...
namespace WebApplication3.Controllers
{
    public partial class DirectiveController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected DirectiveController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DirectiveController Actions { get { return MVC.Directive; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Directive";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Directive";
